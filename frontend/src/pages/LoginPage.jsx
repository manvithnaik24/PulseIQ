...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-bg-custom text-slate-800 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      {/* Main Container */}
      <motion.div 
        className="w-full max-w-5xl bg-white/70 backdrop-blur-xl rounded-[32px] border border-white/40 shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[600px] z-10"
      ...
      >
        ...
        <div className="hidden lg:flex lg:col-span-5 bg-primary p-12 flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="space-y-6 relative z-10">
            <h2 className="text-3xl font-extrabold leading-tight">Welcome Back to Premium Health Custody.</h2>
            <p className="text-white/80 text-sm leading-relaxed">
              Login to view your customized AI vitals logs, upcoming doctor appointments, and check in with your personal medical AI assistant.
            </p>
          </div>
